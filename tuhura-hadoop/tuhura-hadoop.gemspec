Gem::Specification.new do |s|
  s.name               = "tuhura-hadoop"
  s.version            = "0.0.1"
  s.default_executable = "tuhura-hadoop"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Chief Max"]
  s.date = '2013-03-06'
  s.description = %q{A collection of hadoop capabilites used throughout the Tuhura environment}
